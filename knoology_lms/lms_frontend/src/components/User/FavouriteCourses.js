...
const Loader = ({ size = "medium" }) => {
    ...
    return (
        <div className="text-center py-4">
            ...
            <p className="mt-3 text-muted">Loading favorite courses...</p>
        </div>
    );
};
...
function FavouriteCourses() {
    ...
    useEffect(() => {
        document.title = "Favorite Courses | Knoology LMS";
        const fetchFavoriteCourses = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${baseUrl}/favorite-courses/${studentId}/`);
                ...
                setError('Failed to load your favorite courses. Please try again later.');
                setLoading(false);
            }
        };
    ...
    const handleRemoveFavorite = async (courseId) => {
        try {
            const result = await Swal.fire({
                title: 'Are you sure?',
                text: "Remove this course from favorites?",
                icon: 'warning',
            ...
            await Swal.fire({
                title: 'Error!',
                text: 'Failed to remove course from favorites. Please try again.',
                icon: 'error'
            });
        } finally {
            setRemoving(null);
            ...
            <div className='row g-4'>
                ...
                <div className='col-md-9'>
                    ...
                    <div className="page-header" style={{
                        background: 'linear-gradient(135deg, #dc3545 0%, #d74d7f 100%)',
                        borderRadius: '20px',
                        padding: '25px',
                        marginBottom: '24px',
                        position: 'relative',
                        ...
                        <div className="position-relative" style={{ zIndex: '1' }}>
                            <div className="d-flex align-items-center">
                                <div style={{
                                    ...
                                    height: '50px',
                                    borderRadius: '12px',
                                    background: 'linear-gradient(45deg, #d74d7f, #dc3545)',
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    <i className="bi bi-heart-fill" style={{ color: 'white', fontSize: '1.5rem' }}></i>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mb-0" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                                        <span style={{ fontWeight: '600' }}>{courses.length}</span> courses you love
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="section-body">
                            ...
                            {courses.length === 0 ? (
                                <div className="empty-state p-5 text-center">
                                    ...
                                    <h5 style={{ color: '#002254', fontWeight: '600', marginBottom: '15px' }}>No Favorite Courses Yet</h5>
                                    <p className="text-muted mb-4">Add courses to your favorites while browsing to access them quickly.</p>
