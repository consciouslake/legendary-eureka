...
function TeacherForgotPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/teacher/forgot-password/', { email });
                        ...
                        <div style={{
                            ...
                            <div className="text-center position-relative" style={{ zIndex: '1' }}>
                                <div className="d-inline-flex align-items-center justify-content-center mb-4" style={{
                                    ...
                                    <i className="bi bi-envelope-paper" style={{ fontSize: '2.5rem', color: 'white' }}></i>
                                </div>
                                <h2 style={{ color: 'white', fontWeight: '600', marginBottom: '10px' }}>Forgot Password</h2>
                                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '1rem' }}>Recover your teacher account access</p>
                            </div>
                        </div>
